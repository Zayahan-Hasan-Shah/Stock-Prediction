...
import 'package:stock_algo_comparison/widgets/linear_and_actual_data_widget/linear_and_actual_data_widget.dart';
...
class LinearAndActualData extends StatelessWidget {
  @override
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: LinearAndActualDataWidget(
              actual: actual,
