...
import 'package:stock_algo_comparison/widgets/lstm_and_actual_data_widget/lstm_and_actual_data_widget.dart';
...
class LstmAndActualData extends StatelessWidget {
  const LstmAndActualData({super.key});
      ...
      body: Column(
        children: [
          ...
          PerformanceTable({
            ...
            // },
            'LSTM': {'MAE': lstmMAE, 'RMSE': lstmRMSE, 'R²': lstmRSquared},
          }),

          // Line chart to visualize the actual and predicted data
          Expanded(
            child: LstmAndActualDataWidget(
              actual: actual,
